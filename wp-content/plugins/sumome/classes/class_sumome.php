...
class WP_Plugin_SumoMe
{
    ...
    public function __construct(){
        ...
        // WooCommerce helpers
        add_action('wp_ajax_nopriv_sumo_get_woocommerce_cart_subtotal', [$this, 'ajax_sumo_get_woocommerce_cart_subtotal']);
    ...
    public function admin_menu(){
        add_menu_page('Sumo', 'Sumo', 'manage_options', 'sumo', [$this,'sumome_render_dashboard_page'], plugins_url('images/icon.png', SUMOME__PLUGIN_FILE));

        if(isset($_COOKIE['__smUser'])){
            add_submenu_page('sumo', 'Dashboard', 'Dashboard', 'manage_options', 'sumo', [$this,'sumome_render_dashboard_page']);
            add_submenu_page('sumo', 'Statistics', 'Statistics', 'manage_options', 'sumo-statistics', [$this,'sumome_render_statistics_page']);
            add_submenu_page('sumo', 'About', 'About', 'manage_options', 'sumo-about', [$this,'sumome_render_welcome_page']);
        }

        add_submenu_page('sumo', 'SiteID', 'SiteID', 'manage_options', 'sumo-siteID', [$this,'sumome_render_siteID_page']);
    }
    ...
    private function blacklisted_site_id($site_id){
        ...
        if($site_id && in_array($site_id, $blacklist)){
            return true;
        }
    }
