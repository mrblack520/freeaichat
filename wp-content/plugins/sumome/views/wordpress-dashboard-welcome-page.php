            ...
            <div class="sumome-wp-dash-logged-in <?php print $sumomeStatus ?>">
                ...
                <div class="sumome-plugin-dashboard-widget-header-button">
                    <button type="submit" class="button green dashboard-button"
                            onclick="document.location.href='<?php print admin_url('admin.php?page=sumo') ?>'">DASHBOARD
                    </button>
                </div>
            </div>
    ...
    <div class="sumome-plugin-dashboard-widget-container">
        ...
        <div class="sumome-plugin-dashboard-widget-row">
            ...
            <div class="sumome-plugin-right"><img
                        src="<?php print plugins_url('images/sumome-site-welcome1.png', dirname(__FILE__)) ?>"></div>
        </div>

        <div class="sumome-plugin-dashboard-widget-row no-mobile">
            <div class="sumome-plugin-left"><img
                        src="<?php print plugins_url('images/sumome-site-welcome2.png', dirname(__FILE__)) ?>"></div>
        ...
        <div class="sumome-plugin-dashboard-widget-row">
            ...
            <div class="sumome-plugin-right"><img
                        src="<?php print plugins_url('images/sumome-site-welcome3.png', dirname(__FILE__)) ?>"></div>
        </div>
